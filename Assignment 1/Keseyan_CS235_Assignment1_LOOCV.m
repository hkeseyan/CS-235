...
for j = 1 : size(TRAIN,1)
    ...
    for i = 1 : length(TEST_class_labels) % Loop over every instance in the test set
       ...
       disp([int2str(j), ' out of ', int2str(size(TRAIN,1)+1), ' done']) % Report progress
    end;
end
%%%%%%%%%%%%%%%%% Create Report %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function Beef_LOOCV %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% (C) Eamonn Keogh %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
TRAIN = load('Beef_TRAIN'); % Only these two lines need to be changed to test a different dataset. %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

for j = 1 : size(TRAIN,1)
    TRAIN = load('Beef_TRAIN');
    TEST = TRAIN(j,:);                  % identify the test example
    TRAIN(j,:) = [];                    % remove test example from training set
...
function ShapesAll_LOOCV %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% (C) Eamonn Keogh %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
TRAIN = load('ShapesAll_TRAIN'); % Only these two lines need to be changed to test a different dataset. %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

for j = 1 : size(TRAIN,1)
    TRAIN = load('ShapesAll_TRAIN');
    TEST = TRAIN(j,:);                  % identify the test example
    TRAIN(j,:) = [];                    % remove test example from training set
